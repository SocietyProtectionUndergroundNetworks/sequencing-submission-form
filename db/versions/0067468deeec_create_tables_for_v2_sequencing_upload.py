...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "latest_metadata_filename", sa.String(length=255), nullable=True
        ),
        sa.Column(
            "final_metadata_filename", sa.String(length=255), nullable=True
        ),
        ...
        sa.Column(
            "Multiple_sequencing_runs", sa.String(length=255), nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["project_id"], ["buckets.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "Transport_refrigeration", sa.String(length=255), nullable=True
        ),
        sa.Column("Drying", sa.String(length=255), nullable=True),
        sa.Column("Date_collected", sa.String(length=255), nullable=True),
        sa.Column(
            "DNA_concentration_ng_ul", sa.String(length=255), nullable=True
        ),

...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "fastqc_process_id", mysql.VARCHAR(length=255), nullable=True
        ),
        sa.Column(
            "fastqc_sent_to_bucket",
            mysql.TINYINT(display_width=1),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "renamed_sent_to_bucket",
            mysql.TINYINT(display_width=1),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "renamed_sent_to_bucket_progress",
            mysql.INTEGER(display_width=11),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "fastqc_files_progress", mysql.VARCHAR(length=255), nullable=True
        ),
        ...
        sa.Column(
            "metadata_filename", mysql.VARCHAR(length=255), nullable=True
        ),
        sa.Column(
            "renaming_skipped",
            mysql.TINYINT(display_width=1),

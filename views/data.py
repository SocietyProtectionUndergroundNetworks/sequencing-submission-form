...
@data_bp.route('/generate_download_link', methods=['POST'], endpoint='generate_download_link')
@login_required
...
@data_bp.route('/create_bucket_archive', methods=['POST'], endpoint='create_bucket_archive')
@login_required
@approved_required
